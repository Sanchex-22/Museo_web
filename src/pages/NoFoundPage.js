  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center p-8 ">
        <Link className="text-white flex justify-center items-center text-lg text-center font-bold w-28 h-16 bg-[#7d6aa5] rounded-md shadow-xl shadow-black" to= "/home" >Regresar</Link>
      </div>
    </div>
  );
}
